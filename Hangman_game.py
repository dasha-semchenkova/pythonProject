    ...
    while tries:
        ...
        if len(guess) == 1 and guess.isalpha():
            if guess in guessed_letters:
                guess = input('Ты уже называл эту букву, давай другую: ').upper()
            elif guess not in word:
                tries -= 1
                print(f'Буквы {guess} нет, у тебя осталось {tries} попыток.')
            ...
            if guess in guessed_words:
                print('Ты уже называл слово', guess)
            elif guess != word:
...
def play_question():
    question = input('Хочешь сыграть ещё раз? Введи Да или Нет: ')
